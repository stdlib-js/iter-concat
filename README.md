...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/iter-concat/tags). For example,

```javascript
iterConcat = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/iter-concat@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterConcat = require( 'path/to/vendor/umd/iter-concat/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/iter-concat/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/iter-concat/actions/workflows/test.yml?query=branch:v0.2.2
...
[deno-readme]: https://github.com/stdlib-js/iter-concat/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/iter-concat/tree/umd
[umd-readme]: https://github.com/stdlib-js/iter-concat/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/iter-concat/tree/esm
[esm-readme]: https://github.com/stdlib-js/iter-concat/blob/esm/README.md
